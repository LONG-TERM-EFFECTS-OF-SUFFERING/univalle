...
(define grammar-simple-interpreter
  '((programa (expresion) un-programa)
    ...
    (expresion
     ...
     primitiva-exp)
    (expresion ("Si" expresion "entonces" expresion "sino" expresion "fin")
                condicional-exp)
    (expresion ("declarar" (arbno identifier "=" expresion ";") "haga" expresion "fin")
                variablelocal-exp)
    (expresion ("proc" "[" (separated-list identifier ";") "]" "haga" expresion "fin")
                procedimiento-exp)
    (expresion ("evaluar" expresion "enviando" "[" (separated-list expresion ";") "]" "fin")
                proc-evaluacion-exp)
    
    ; características adicionales
    (expresion ("recursivo" (arbno identifier "[" (separated-list identifier ";") "]" "=" expresion)  "haga" expresion "fin") 
                recursivo-exp)
    ;;;;;;
